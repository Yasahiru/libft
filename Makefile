...
SRC =  ft_atoi.c ft_isdigit.c ft_memcpy.c ft_split.c \
	ft_isprint.c ft_memmove.c ft_strchr.c ft_strmapi.c \
	...
	ft_isalpha.c ft_memchr.c ft_putnbr_fd.c ft_strlcat.c \
	ft_isascii.c ft_memcmp.c ft_putstr_fd.c ft_strlcpy.c \
	ft_tolower.c ft_substr.c ft_strtrim.c ft_strncmp.c \
